function varargout = kaigreene(varargin)
% KAIGREENE MATLAB code for kaigreene.fig
%      KAIGREENE, by itself, creates a new KAIGREENE or raises the existing
%      singleton*.
%
%      H = KAIGREENE returns the handle to a new KAIGREENE or the handle to
%      the existing singleton*.
%
%      KAIGREENE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in KAIGREENE.M with the given input arguments.
%
%      KAIGREENE('Property','Value',...) creates a new KAIGREENE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before kaigreene_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to kaigreene_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help kaigreene

% Last Modified by GUIDE v2.5 23-Mar-2017 13:08:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @kaigreene_OpeningFcn, ...
                   'gui_OutputFcn',  @kaigreene_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before kaigreene is made visible.
function kaigreene_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to kaigreene (see VARARGIN)

% Choose default command line output for kaigreene
...
% UIWAIT makes kaigreene wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = kaigreene_OutputFcn(hObject, eventdata, handles) 
